...
RSpec.describe Fx::Function do
  describe "#<=>" do
    it "delegates to `name`" do
      function_a =
        Fx::Function.new("name" => "name_a", "definition" => "some definition")
      function_b =
        Fx::Function.new("name" => "name_b", "definition" => "some definition")
      function_c =
        Fx::Function.new("name" => "name_c", "definition" => "some definition")
